...
>>>>>>> dcb1d5e377d419f5eeb608ddf2980a4a56eb09f5
	...
	<?php
				...
				$paginas = array('home','carrinho','categoria','subcategorias','produto',
								 ...
								 'pagamento','transferencia','nao-logado','meus-dados','login','lojacompleta','lista-cursos');
		...
		<div class="section">
			...
			<div class="container">
				...
				<!-- section title -->
					<div class="col-md-12">
						<div class="section-title">
							<h3 class="title"><?php echo $lst_categoria["categoria"]?></h3>
							<div class="section-nav">
								<ul class="section-tab-nav tab-nav">
							...
							<div class="products-tabs">
								...
								<div id="tab2" class="tab-pane fade in active">
									...
									<div class="products-slick" data-nav="#slick-nav-2">
										...
										<div class="product">
											<div class="product-img">
											<a  href="<?php echo URL_BASE ?>produto/?p=4"><img style="width:200px; height:240px;" src="produtos/<?php echo $lst_produto["imagem"]?>" title="<?php echo $lst_produto["produto"]?>"</a>
												<div class="product-label">
													<span class="sale">-30%</span>
													<span class="new">NEW</span>
												</div>
											...
											<div class="product-body">
												<p class="product-category"><?php echo $lst_categoria["categoria"]?></p>

												<h3 class="product-name"><a href="<?php echo URL_BASE ?>produto/?p=<?php echo $lst_produto["id_produto"]?>">
												<?php echo limita_caracteres($lst_produto["produto"],40)?></a></h3>

												<h5 class="product-price"><?php echo $lst_produto["preco"]?><del class="product-old-price"><?php echo $lst_produto["preco_alto"]?></del></h5>
												<div class="product-rating">
													<i class="fa fa-star"></i>
													<i class="fa fa-star"></i>
													<i class="fa fa-star"></i>
												...
												<div class="product-btns">
													...
													<a class="quick-view" href="<?php echo URL_BASE ?>produto/?p=<?php echo $lst_produto["id_produto"]?>" >
